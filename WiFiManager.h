...
class WiFiManager
{
  public:
	...
	//toggle shwowing the password field or not for enterprise wifi connections with RADIUS servers
	void          setShowPasswordField(boolean show);
  ...
  private:
	...
	boolean		  _activePassword         = false;       // show or hide password field
